...
// Require all the models
	...
	// This is an acceptable pattern but it does have limitations in that if you change the name of the model you will have to change every time it is require everywhere
